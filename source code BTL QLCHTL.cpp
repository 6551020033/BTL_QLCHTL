...
void muaHang() {
    ...
    if (!foundSP) {
        cout << "=> Khong tim thay san pham hoac san pham da ngung ban!\n";
        return;
    }

    cout << "\n===== THONG TIN SAN PHAM =====\n";
    cout << "Ten SP      : " << foundSP->getTen() << endl;
    cout << "Gia         : " << fixed << setprecision(0)
         << foundSP->getGia() << " VND / "
         << foundSP->getDVT() << endl;

    cout << "Ton kho     : " << foundSP->getSoLuong()
         << " " << foundSP->getDVT() << endl;
    ...
    cout << "\n===== CHON DON VI MUA =====\n";
    cout << "1. Mua le (" << foundSP->getDVT() << ")\n";
    cout << "2. Mua theo loc (6 don vi)\n";
    cout << "3. Mua theo thung (24 don vi)\n";
    cout << "Chon: ";
    cin >> luaChonDV;
    ...
    if (luaChonDV == 1) {
        ...
        tongSL = soLuongMua * 24;
    }
    else {
        cout << "Lua chon don vi khong hop le!\n";
        return;
    }

    if (tongSL > foundSP->getSoLuong()) {
        cout << "=> Kho khong du hang!\n";
        return;
    }

    gioHang.themSP(foundSP->getMa(), tongSL);
    ...
    double tamTinh = tongSL * foundSP->getGia();
